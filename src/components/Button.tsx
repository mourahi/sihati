...
const BASE =
  "inline-flex items-center justify-center gap-2 rounded-[1.5rem] px-5 py-2.5 text-sm font-semibold transition duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose";
