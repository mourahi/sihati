...
import { ProgramZoneNav } from '../components/ProgramZoneNav'
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
      <div className="flex flex-col-reverse gap-8 lg:flex-row lg:items-start">
        ...
        <aside className="w-full shrink-0 lg:sticky lg:top-36 lg:w-56">
          <ProgramZoneNav currentZone={program.zone} />
        </aside>
      </div>
    </div>
  )
